...
A command-line application that uses a SQL database to track employees, their roles, and their respective department within a company.
When the user runs the application in the Terminal:
...
Ensure you have MySql before beginning to use this application.
